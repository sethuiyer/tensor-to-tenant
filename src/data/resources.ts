 ...
 * Source of truth: schema/resources.yaml + schema/source_data.yaml (generated view).
 */
...
export const BLOG_ARTICLES: BlogLink[] = [{ title: 'The shift to distributed LLM inference (BentoML)', url: 'https://www.bentoml.com/blog/the-shift-to-distributed-llm-inference' }, { title: 'Collective operations (Aleksa Gordić)', url: 'http://www.aleksagordic.com/blog/collective-operations' }, { title: 'ELI5 FlashAttention (Aleksa Gordić)', url: 'https://gordicaleksa.medium.com/eli5-flash-attention-5c44017022ad' }, { title: 'vLLM (Aleksa Gordić)', url: 'https://www.aleksagordic.com/blog/vllm' }, { title: 'Matmul (Aleksa Gordić)', url: 'https://www.aleksagordic.com/blog/matmul' }, { title: 'Transformer (Aleksa Gordić)', url: 'https://www.aleksagordic.com/blog/transformer' }, { title: 'Making Deep Learning Go Brrrr From First Principles (Horace He)', url: 'https://horace.io/brrr_intro.html' }, { title: 'Stanford CS336 Spring 2025 lectures', url: 'https://github.com/stanford-cs336/spring2025-lectures' }, { title: 'CS336 Lecture 5 (Percy Liang, Tatsunori Hashimoto)', url: 'https://www.youtube.com/watch?v=fcgPYo3OtV0' }, { title: 'GPU MODE Lecture 22 — Hacker’s Guide to Speculative Decoding', url: 'https://www.youtube.com/watch?v=6OBtO9niT00' }, { title: 'Transformer Inference Arithmetic (kipply)', url: 'https://kipp.ly/transformer-inference-arithmetic/' }, { title: 'Databricks — LLM Inference Performance Engineering', url: 'https://www.databricks.com/blog/llm-inference-performance-engineering-best-practices' }, { title: 'PagedAttention announcement (vLLM blog)', url: 'https://blog.vllm.ai/2023/06/20/vllm.html' }, { title: 'vLLM on Modal', url: 'https://modal.com/docs/examples/vllm_inference' }, { title: 'vLLM Office Hours 22: Intro to vLLM V1', url: 'https://www.youtube.com/watch?v=jmzIvQZCLZM' }, { title: 'vLLM V1 architecture', url: 'https://blog.vllm.ai/2025/01/27/v1-alpha-release.html' }, { title: 'Anatomy of a High-Throughput Inference System', url: 'https://blog.vllm.ai/2025/09/05/anatomy-of-vllm.html' }, { title: 'vLLM repo', url: 'https://github.com/vllm-project/vllm' }, { title: 'vLLM V1 metrics design doc', url: 'https://docs.vllm.ai/en/latest/design/v1/metrics/' }, { title: 'Prometheus/Grafana example (vLLM)', url: 'https://docs.vllm.ai/en/latest/examples/online_serving/prometheus_grafana/' }, { title: 'NVIDIA benchmarking fundamentals', url: 'https://developer.nvidia.com/blog/llm-inference-benchmarking-fundamental-concepts/' }, { title: 'How to Benchmark LLM Engines (Modal)', url: 'https://modal.com/llm-almanac/how-to-benchmark' }, { title: 'GuideLLM intro talk', url: 'https://www.youtube.com/watch?v=0ZVu0A4wWQg' }, { title: 'GuideLLM repo', url: 'https://github.com/vllm-project/guidellm' }, { title: 'vLLM bench serve CLI', url: 'https://docs.vllm.ai/en/latest/benchmarking/cli/' }, { title: 'Triton perf_analyzer', url: 'https://github.com/triton-inference-server/perf_analyzer' }, { title: 'Practical strategies for vLLM performance tuning (Red Hat)', url: 'https://developers.redhat.com/articles/2026/03/03/practical-strategies-vllm-performance-tuning' }, { title: 'Lilian Weng — Inference Optimization survey', url: 'https://lilianweng.github.io/posts/2023-01-10-inference-optimization/' }, { title: 'vLLM quantization docs', url: 'https://docs.vllm.ai/en/latest/features/quantization/' }, { title: 'QLoRA talk (Tim Dettmers)', url: 'https://www.youtube.com/watch?v=9wNAgpX6z_4' }, { title: 'vLLM production stack', url: 'https://github.com/vllm-project/production-stack' }, { title: 'KServe autoscaling for vLLM with KEDA (Red Hat)', url: 'https://developers.redhat.com/articles/2025/09/23/how-set-kserve-autoscaling-vllm-keda' }, { title: 'LLM Inference Economics from First Principles (TensorEconomics)', url: 'https://www.tensoreconomics.com/p/llm-inference-economics-from-first' }, { title: 'DigitalOcean — LLM Inference Cost', url: 'https://www.digitalocean.com/community/tutorials/llm-inference-cost' }, { title: 'Character.AI — Optimizing AI Inference', url: 'https://blog.character.ai/optimizing-ai-inference-at-character-ai-2/' }, { title: 'NVIDIA — Mastering LLM Techniques: Inference Optimization', url: 'https://developer.nvidia.com/blog/mastering-llm-techniques-inference-optimization/' }, { title: 'SGLang intro (Lianmin Zheng)', url: 'https://www.youtube.com/watch?v=Ny4xxErgFgQ' }, { title: 'SGLang v0.4 zero-overhead scheduler', url: 'https://lmsys.org/blog/2024-12-04-sglang-v0-4/' }, { title: 'RadixAttention / SGLang blog', url: 'https://lmsys.org/blog/2024-01-17-sglang/' }, { title: 'SGLang docs', url: 'https://docs.sglang.io' }, { title: 'Warp Decode — better MoE model inference (Cursor)', url: 'https://cursor.com/blog/warp-decode' }, { title: 'Mixture-of-Kittens — deterministic MoE megakernel for NVL72s (Cursor)', url: 'https://cursor.com/blog/mixture-of-kittens' }];
