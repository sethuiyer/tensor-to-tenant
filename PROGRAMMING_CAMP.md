...
1. Basic Geometry/Euclidean Geometry/Coordfinate Geometry/ [3-D variants of everything].
...
■ BSHEEP, BULK, SEGVIS, CONDUIT, RUNAWAY, DIRVS, RAIN1, SHAMAN, TCUTTER, LITEPIPE, RHOMBS, FSHEEP, FLBRKLIN, CERC07P, B
CERC07C, NECKLACE, CH3D, RECTANGL, POLYSSQ, FOREST2, KPPOLY, RAIN2, SEGMENTS, ARCHPLG, BALLOON, CIRCLES, COMPASS, EOW
SPOJ.
...
g. Manachar’s algorithm to find Lengh of palindromic substring of a string centered at a position for each position in the stri
O(n).
...
a. Representation of graphs as adjacency list, adjacency matrix, incidence matrix and edge list and uses of different represent
scenarios.
...
■ problems - GREED, SCITIES, TOURS on SPOJ | http://www.topcoder.com/stat?c=problem_statement&pm=8143■ i) Problems - MCQUERY on Spoj.
...
Syllabus
■ Matrix Operations
1. Addition and subtraction of matricesa. Suggested Reading
i. Cormen 28.1
...
■ Polynomials
1. Roots of a polynomial [ Prime factorization of a polynomial, Integer roots of a polynomial, All real roots of
a. Problems
